...
description: "Use this agent to create an implementation plan for backend tasks (B*.*). Explores the codebase, identifies reusable code, and writes a structured plan INTO the ticket file. NEVER writes implementation code."
