...
- [ ] **Admin Analytics (Dashboard)**
  ...
  - [ ] Ticket: [MVP-10.2-analytics-charts.md](docs/tickets/MVP-10.2-analytics-charts.md) (Recharts Time-series Visuals)
  - [ ] Ticket: [MVP-10.3-analytics-funnel.md](docs/tickets/MVP-10.3-analytics-funnel.md) (Add to Cart Funnel Metrics)
